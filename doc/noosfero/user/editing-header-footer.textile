h1(order-540). Editing header and footer

p.  _You can customize your page, adding some text or image on header or footer._
...
# Then, click on "Edit Header and Footer":  !=/images/doc/control-panel-user-edit-header-footer.en.png(Edit header and footer on user control panel)!
...
###  *Underline:* it is also used to emphasize a word/phrase. One line is drawn under the word. Example: %{text-decoration:
##underline;}home% . To use it, first you should select the word/phrase and then click on button
