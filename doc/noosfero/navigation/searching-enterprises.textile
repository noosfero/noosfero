...
# In this example, we searched for "software". Then you will see the search results. To see more results, click on the pages below the search results.  !=/images/doc/enterprises-search-results-with-example.en.png(Enteprises search results with example)!
