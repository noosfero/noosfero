...
# Fill in the field "Title" with the name of the article you want to create. Below, there is a space for text, where you will write the content of your article. You can write your text the same way you write in others text editors.
  !=/images/doc/article-text.en.png(Text on an article)!
...
###  *Strikethrough:* one line in drawn in the middle of word/phrase Example: %{text-decoration:
##line-through;}home% . To use it, first you should select the word/phrase and then click on button
