h1(order-250). Editing header and footer

p.  _You can customize the page of your enterprise, adding some text or image on header or footer._
...
# You will see the list of groups (communities/enterprises) that you are a member. The groups that you can manage are listed with a link "Manage". Assuming that you are a community administrator, click on "Manage" link. !=/images/doc/groups-list-with-manage-enterprise.en.png(Groups list with permission to manage enterprise)!
# Then, click on "Edit Header and Footer":  !=/images/doc/control-panel-enterprise-edit-header-footer.en.png(Edit header and footer on enterprise control panel)!
