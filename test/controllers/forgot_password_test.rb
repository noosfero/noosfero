...
class ForgotPasswordTest < ActionDispatch::IntegrationTest
  ...
  def test_forgot_password_with_login
    ...
    post '/account/forgot_password', params: { field: 'login', 
                                               value: 'forgotten',
    ...
    post "/account/new_password/#{code}", params: { change_password: { password: 'newpass', password_confirmation: 'newpass'} }
    assert_response :success
  ...
  def test_forgot_password_with_email
    ...
    post '/account/forgot_password', params: {
                                              field: 'email', 
                                              value: 'forgotten@localhost.localdomain',
                                              environment_id: Environment.default.id
                                             }
