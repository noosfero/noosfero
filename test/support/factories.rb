module Noosfero::Factory
  ...
  def create_admin_user(env)
    admin_user = User.find_by(login: 'adminuser') || create_user('adminuser', :email => 'adminuser@noosfero.org', :password => '123456', :password_confirmation => '123456', :environment => env)
