...
/*global window : false, clearInterval: false, clearTimeout: false, document: false, setInterval: false, setTimeout: false, jQuery_1_8_3: false, navigator: false, XSLTProcessor: false, DOMParser: false, XMLSerializer: false, ActiveXObject: false */

"use strict";

// top wrapper to prevent multiple inclusion (is this OK?)
(function () { if(jQuery_1_8_3 && jQuery_1_8_3.jstree) { return; }
...
(function ($) {
	...
	// jQuery_1_8_3 plugin wrapper (thanks to jquery UI widget function)
	...
	$(function() {
		// code is copied from jQuery_1_8_3 ($.browser is deprecated + there is a bug in IE)
...
(function ($) {
	...
	$.jstree.plugin("hotkeys", {
		__init : function () {
			if(typeof $.hotkeys === "undefined") { throw "jsTree hotkeys: jQuery_1_8_3 hotkeys plugin not included."; }
...
(function ($) {
	$.jstree.plugin("cookies", {
		__init : function () {
			if(typeof $.cookie === "undefined") { throw "jsTree cookie: jQuery_1_8_3 cookie plugin not included."; }
 ...
 * Adds support for jQuery_1_8_3 UI themes. Include this at the end of your plugins list, also make sure "themes" is not included.
 */
(function ($) {
