module ThickboxHelper
  ...
  def thickbox_inline_popup_icon(type, title, id, options = {})
    icon_button(type, title, "#TB_inline?height=300&width=500&inlineId=#{id}&modal=true", {:class => "thickbox"}.merge(options))
  end
