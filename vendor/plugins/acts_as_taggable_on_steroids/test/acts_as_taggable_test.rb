...
#  end
  ...
  def test_inherited_taggable
    # SpPost inherits acts_as_taggable from its ancestor Post
    p = SpPost.new(:text => 'bla bla bla ...') 
    p.tag_list = 'bla'
    p.save
    assert !SpPost.find_tagged_with('bla').blank?
  end
end
